        ...
        <div className="grid md:grid-cols-3 gap-6">
          {collections.map((collection, index) => (
            <div
              ...
              className="group relative overflow-hidden rounded-2xl bg-gradient-to-br p-8 hover:shadow-2xl transition-all duration-300 animate-fade-in"
            ...
            >
              ...
              <div className="relative z-10 space-y-4">
                ...
                <Button variant="outline" className="group/btn bg-background/80 backdrop-blur-sm">
                  Explore Collection
